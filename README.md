...
DesignLaptop is a script to set up an OS X computer for design/web development.
...
```sh
curl --remote-name https://raw.githubusercontent.com/georgevaldes/designlaptop/master/mac
cat mac
...
* [Adobe Creative Cloud] for all your design tools
* [Sketch] for web / app designs
* [Sketch Toolbox] for managing Sketch plugins
...
Credits
-------
This laptop script is a modification of [Monfresh's laptop](https://github.com/monfresh/laptop) script.
